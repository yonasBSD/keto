...
const file_ory_keto_opl_v1alpha1_syntax_service_proto_rawDesc = "" +
	"\n" +
	"*ory/keto/opl/v1alpha1/syntax_service.proto\x12\x15ory.keto.opl.v1alpha1\"(\n" +
	"\fCheckRequest\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontent\"U\n" +
	"\rCheckResponse\x12D\n" +
	"\fparse_errors\x18\x01 \x03(\v2!.ory.keto.opl.v1alpha1.ParseErrorR\vparseErrors\"\x9c\x01\n" +
	"\n" +
	"ParseError\x12\x18\n" +
	...
	"\x06column\x18\x02 \x01(\rR\x06column2c\n" +
	"\rSyntaxService\x12R\n" +
	"\x05Check\x12#.ory.keto.opl.v1alpha1.CheckRequest\x1a$.ory.keto.opl.v1alpha1.CheckResponseB\x95\x01\n" +
