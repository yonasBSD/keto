...
const file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDesc = "" +
	"\n" +
	"4ory/keto/relation_tuples/v1alpha2/read_service.proto\x12!ory.keto.relation_tuples.v1alpha2\x1a7ory/keto/relation_tuples/v1alpha2/relation_tuples.proto\x1a google/protobuf/field_mask.proto\"\x8b\x04\n" +
	"\x19ListRelationTuplesRequest\x12\\\n" +
	"\x05query\x18\x01 \x01(\v2B.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesRequest.QueryB\x02\x18\x01R\x05query\x12W\n" +
	"\x0erelation_query\x18\x06 \x01(\v20.ory.keto.relation_tuples.v1alpha2.RelationQueryR\rrelationQuery\x12;\n" +
	"\vexpand_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"expandMask\x12\x1c\n" +
	"\tsnaptoken\x18\x03 \x01(\tR\tsnaptoken\x12\x1b\n" +
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tR\tpageToken\x1a\x9f\x01\n" +
	"\x05Query\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12\x16\n" +
	"\x06object\x18\x02 \x01(\tR\x06object\x12\x1a\n" +
	"\brelation\x18\x03 \x01(\tR\brelation\x12D\n" +
	"\asubject\x18\x04 \x01(\v2*.ory.keto.relation_tuples.v1alpha2.SubjectR\asubject\"\x9f\x01\n" +
	"\x1aListRelationTuplesResponse\x12Y\n" +
	"\x0frelation_tuples\x18\x01 \x03(\v20.ory.keto.relation_tuples.v1alpha2.RelationTupleR\x0erelationTuples\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xa1\x01\n" +
	"\vReadService\x12\x91\x01\n" +
	"\x12ListRelationTuples\x12<.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesRequest\x1a=.ory.keto.relation_tuples.v1alpha2.ListRelationTuplesResponseB\xc1\x01\n" +
	"$sh.ory.keto.relation_tuples.v1alpha2B\x10ReadServiceProtoP\x01Z?github.com/ory/keto/proto/ory/keto/relation_tuples/v1alpha2;rts\xaa\x02 Ory.Keto.RelationTuples.v1alpha2\xca\x02 Ory\\Keto\\RelationTuples\\v1alpha2b\x06proto3"

var (
	file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDescOnce sync.Once
	file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDescData []byte
)
...
func file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDescGZIP() []byte {
	file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDescOnce.Do(func() {
		file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDesc), len(file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDesc)))
	})
...
func file_ory_keto_relation_tuples_v1alpha2_read_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDesc), len(file_ory_keto_relation_tuples_v1alpha2_read_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
